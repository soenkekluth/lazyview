...
var LazyView = function (_EventDispatcher) {
  ...
  LazyView.prototype.onLoadChild = function onLoadChild() {
    var _this2 = this;

    setTimeout(function () {
      if (_this2.el && _this2.el.clientHeight !== _this2.position.height) {
        _this2.scroll.trigger('scroll:resize');
      }
    }, 1);
  };
...
var LazyViewCollection = function (_EventDispatcher2) {
  ...
  function LazyViewCollection() {
    ...
    var _this4 = (0, _possibleConstructorReturn3.default)(this, _EventDispatcher2.call(this));
